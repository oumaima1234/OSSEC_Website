    ...
    return (
      <Toolbar className={classes.root} role={'toolbar'} aria-label={'Table Toolbar'}>
        <div className={classes.left}>
          {showSearch === true ? (
            <TableSearch id= {'tablesearch'} onSearch={searchTextUpdate} onHide={this.hideSearch} options={options} />
          ) : (
        ...
        <div className={classes.actions}>
          ...
          {options.download && (
            <Tooltip title={downloadCsv}>
              <IconButton  id = "button-download" aria-label={downloadCsv} classes={{ root: classes.icon }} onClick={this.handleCSVDownload}>
          ...
          {options.print && (
            <Tooltip title={print}>
              <span>
                <ReactToPrint
                  trigger={() => (
                    <IconButton  id = "button-print" aria-label={print} classes={{ root: classes.icon }}>
                      <PrintIcon id = "icon-print"/>
                    </IconButton>
                  )}
